...
export const PaintbrushIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="m12 22 1-1c1.4-1.4 2.4-3.2 3-5.2l.5-1.7a1 1 0 0 1 1.2-.7h.1a1 1 0 0 1 .7 1.2v0c-.1 2 .4 4.1 1.7 5.6l.8.8" />
    <path d="M18.8 8.1 14 3.3a1 1 0 0 0-1.4 0l-8.3 8.3a2 2 0 0 0 0 2.8l3.1 3.1a2 2 0 0 0 2.8 0l8.3-8.3a1 1 0 0 0 0-1.4Z" />
    <path d="M14 8.7 9.3 4" />
  </svg>
);
